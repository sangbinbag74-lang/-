    ...
    try {
        ...
        switch (mode) {
            ...
            case 'generate_article':
                systemPrompt += " 제공된 짧은 아이디어나 키워드를 바탕으로, 관련된 배경 지식과 맥락을 추가로 구성하여 전문가 수준의 완성된 뉴스 기사를 작성해 주세요. 서론, 본론, 결론의 흐름을 갖추고, 필요시 적절한 소제목(Markdown ### 등)을 추가해 풍성하고 깊이 있는 기사 본문만 출력해 주세요.";
                break;
            default:
