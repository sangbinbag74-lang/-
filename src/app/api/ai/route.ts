    ...
    try {
        ...
        switch (mode) {
            ...
            case 'generate_article':
                systemPrompt += " 제공된 짧은 아이디어나 키워드를 바탕으로, 관련된 배경 지식과 맥락을 추가로 심층 취재하여 전문가 수준의 뉴스 기사를 작성해 주세요. 기사는 사실적이고 객관적인 언론 보도 형식(저널리즘 톤)이어야 하며, 불필요한 마크다운 기호(예: ### 등)나 소제목을 남발하지 말고, 단락 구분을 통해 자연스럽게 서론, 본론, 결론이 유려하게 이어지는 완성된 기사 본문을 작성해 주세요. 서술어는 '~다', '~했다' 체로 통일하세요.";
                break;
            default:
